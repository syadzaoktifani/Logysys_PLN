...
>
  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
  Dashboard
</button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              <form onSubmit={handleManualSubmit}>
                ...
                <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  />
                  <InputField label="Keterangan (Opsional)" name="keterangan" value={manualForm.keterangan} onChange={handleManualChange} disabled={isLoading} placeholder="Catatan tambahan bila ada..." className="md:col-span-12 lg:col-span-6" />
